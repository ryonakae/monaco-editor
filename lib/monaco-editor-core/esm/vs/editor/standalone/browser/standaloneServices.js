...
import { SimpleKeybinding, createKeybinding } from '../../../base/common/keybindings';
...
import { IBulkEditService, ResourceTextEdit } from '../../browser/services/bulkEditService';
...
import { ITextResourceConfigurationService, ITextResourcePropertiesService } from '../../common/services/textResourceConfiguration';
...
import { INotificationService, NoOpNotification } from '../../../platform/notification/common/notification';
import { IEditorProgressService } from '../../../platform/progress/common/progress';
import { ITelemetryService } from '../../../platform/telemetry/common/telemetry';
import { IWorkspaceContextService, WorkspaceFolder } from '../../../platform/workspace/common/workspace';
...
import { getSingletonServiceDescriptors, registerSingleton } from '../../../platform/instantiation/common/extensions';
import { OpenerService } from '../../browser/services/openerService';
import { IEditorWorkerService } from '../../common/services/editorWorker';
import { EditorWorkerService } from '../../common/services/editorWorkerService';
...
let StandaloneKeybindingService = class StandaloneKeybindingService extends AbstractKeybindingService {
    constructor(contextKeyService, commandService, telemetryService, notificationService, logService, codeEditorService) {
        ...
        const addCodeEditor = (codeEditor) => {
            if (codeEditor.getOption(53 /* inDiffEditor */)) {
                return;
            }
