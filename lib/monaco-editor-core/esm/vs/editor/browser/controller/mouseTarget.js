...
import { AtomicTabMoveOperations } from '../../common/controller/cursorAtomicMoveOperations';
...
export class MouseTargetFactory {
        ...
        if (request.target) {
            ...
            for (const d of lastViewCursorsRenderData) {
                if (request.target === d.domNode) {
                    return request.fulfill(6 /* CONTENT_TEXT */, d.position, null, { mightBeForeignElement: false, injectedText: null });
                }
            }
        }
    ...
    static _hitTestTextArea(ctx, request) {
        ...
        if (ElementPath.isTextArea(request.targetPath)) {
            if (ctx.lastRenderData.lastTextareaPosition) {
                return request.fulfill(6 /* CONTENT_TEXT */, ctx.lastRenderData.lastTextareaPosition, null, { mightBeForeignElement: false, injectedText: null });
            }
    ...
    static createMouseTargetFromHitTestPosition(ctx, request, spanNode, pos, injectedText) {
        ...
        if (request.mouseContentHorizontalOffset === columnHorizontalOffset) {
            return request.fulfill(6 /* CONTENT_TEXT */, pos, null, { mightBeForeignElement: !!injectedText, injectedText });
        }
        const points = [];
        ...
        for (let i = 1; i < points.length; i++) {
            ...
            if (prev.offset <= request.mouseContentHorizontalOffset && request.mouseContentHorizontalOffset <= curr.offset) {
                ...
                return request.fulfill(6 /* CONTENT_TEXT */, pos, rng, { mightBeForeignElement: !mouseIsOverSpanNode || !!injectedText, injectedText });
            }
        }
        return request.fulfill(6 /* CONTENT_TEXT */, pos, null, { mightBeForeignElement: !mouseIsOverSpanNode || !!injectedText, injectedText });
    }
    /**
