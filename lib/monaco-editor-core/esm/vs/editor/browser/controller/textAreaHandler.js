...
import { CopyOptions, TextAreaInput, TextAreaWrapper } from './textAreaInput';
import { PagedScreenReaderStrategy, TextAreaState, _debugComposition } from './textAreaState';
...
export class TextAreaHandler extends ViewPart {
    ...
    _getWordBeforePosition(position) {
        const lineContent = this._context.model.getLineContent(position.lineNumber);
        const wordSeparators = getMapForWordSeparators(this._context.configuration.options.get(116 /* wordSeparators */));
