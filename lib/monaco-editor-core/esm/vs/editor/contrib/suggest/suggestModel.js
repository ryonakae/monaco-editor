...
import { CompletionProviderRegistry } from '../../common/languages';
...
import { CompletionOptions, getSnippetSuggestSupport, getSuggestionComparator, provideSuggestionItems } from './suggest';
...
let SuggestModel = class SuggestModel {
    ...
    _doTriggerQuickSuggest() {
        ...
        if (this._editor.getOption(105 /* suggest */).snippetsPreventQuickSuggestions && ((_a = SnippetController2.get(this._editor)) === null || _a === void 0 ? void 0 : _a.isInSnippet())) {
