...
import { createCancelablePromise, first, timeout } from '../../../base/common/async';
...
import { EditorAction, registerEditorAction, registerEditorContribution, registerModelAndPositionCommand } from '../../browser/editorExtensions';
...
import { DocumentHighlightKind, DocumentHighlightProviderRegistry } from '../../common/languages';
import * as nls from '../../../nls';
import { IContextKeyService, RawContextKey } from '../../../platform/contextkey/common/contextkey';
import { activeContrastBorder, editorSelectionHighlight, editorSelectionHighlightBorder, minimapSelectionOccurrenceHighlight, overviewRulerSelectionHighlightForeground, registerColor } from '../../../platform/theme/common/colorRegistry';
