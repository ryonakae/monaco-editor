...
import { isStandalone } from '../../../base/browser/browser';
import { alert } from '../../../base/browser/ui/aria/aria';
import { createCancelablePromise, raceCancellation } from '../../../base/common/async';
...
import { EditorStateCancellationTokenSource } from '../../browser/core/editorState';
import { isCodeEditor } from '../../browser/editorBrowser';
import { EditorAction, registerInstantiatedEditorAction } from '../../browser/editorExtensions';
...
import { isLocationLink } from '../../common/languages';
import { ReferencesController } from './peek/referencesController';
import { ReferencesModel } from './referencesModel';
import { ISymbolNavigationService } from './symbolNavigation';
        ...
        const promise = raceCancellation(this._getLocationModel(model, pos, cts.token), cts.token).then((references) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (referenceCount === 0) {
                ...
                if (!this._configuration.muteMessage) {
                    ...
                    (_a = MessageController.get(editor)) === null || _a === void 0 ? void 0 : _a.showMessage(this._getNoResultFoundMessage(info), pos);
                }
            }
