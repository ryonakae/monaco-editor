...
import { InvisibleCharacters } from '../../../base/common/strings';
...
import { inUntrustedWorkspace, unicodeHighlightConfigKeys } from '../../common/config/editorOptions';
import { MinimapPosition, OverviewRulerLane } from '../../common/model';
import { ModelDecorationOptions } from '../../common/model/textModel';
import { UnicodeTextModelHighlighter } from '../../common/languages/unicodeTextModelHighlighter';
import { IEditorWorkerService } from '../../common/services/editorWorker';
import { ILanguageService } from '../../common/services/language';
import { isModelDecorationInComment, isModelDecorationInString, isModelDecorationVisible } from '../../common/viewModel/viewModelDecorations';
import { MarkdownHover, renderMarkdownHovers } from '../hover/markdownHoverParticipant';
...
import { minimapUnicodeHighlight, overviewRulerUnicodeHighlightForeground } from '../../../platform/theme/common/colorRegistry';
...
let UnicodeHighlighterHoverParticipant = class UnicodeHighlighterHoverParticipant {
    constructor(_editor, _hover, _languageService, _openerService) {
        this._editor = _editor;
        this._hover = _hover;
